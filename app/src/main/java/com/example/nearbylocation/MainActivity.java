                ...
                ownMapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        position = new CameraPosition.Builder()
                                .target(new LatLng(userLoc.getLatitude(), userLoc.getLongitude())) // Sets the new camera position
                        ...
                        String latlong = String.valueOf(userLoc.getLatitude()) + "," + String.valueOf(userLoc.getLongitude());
